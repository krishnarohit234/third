...
<div class="container">
  ...
  <mvc:form cssClass="form-horizontal" modelAttribute="product" action="updateProduct" method="post">
  		<table class="table table-striped">        
			<tr>
				...
				<td><mvc:input path="productCode"  readonly="true"/></td>
			...
			<tr>
				<td></td>
				<td>
        			<button type="submit" class="btn btn-default"><spring:message code="productForm.edit"/></button>
